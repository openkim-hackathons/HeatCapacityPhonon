...
average_positionXXX.dump files will be loaded from dir_path
and the output is writen to dir_path/average_position_over_files.ouput
'''
id_pos_dict = {} # the dictionary in the form id:position
def get_id_pos_dict(file_name:str) -> dict:
    ...
    header4pos = ["id","type","f_avePos[1]","f_avePos[2]","f_avePos[3]"]
